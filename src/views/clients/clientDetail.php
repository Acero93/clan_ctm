<?php
    ...
    $clientData         = $clientController->getClientById($client_id, false);
    $attributes         = json_decode($clientData['attributes'], true);
...
<form id="client-form">
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="first_name" name="first_name" value="<?= $clientData['first_name'] ?>" required>
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="last_name" name="last_name" value="<?= $clientData['last_name'] ?>" required>
        <div class="invalid-feedback">
    ...
    <div class="mb-3">
        ...
        <input type="tel" class="form-control" id="phone_number" name="phone_number" value="<?= $clientData['phone_number'] ?>" required>
        <div class="invalid-feedback">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="address" name="address" value="<?= $clientData['address'] ?>" required>
        <div class="invalid-feedback">
    ...
    <div class="mb-3">
        ...
        <input type="number" class="form-control" id="age" name="attributes[age]" value="<?= $attributes['age'] ?>" required min="18" max="100">
        <div class="invalid-feedback">
    ...
    <div class="mb-3">
        ...
        <select class="form-select" id="gender" name="attributes[gender]" required>
            ...
            <option value="other" <?= $attributes['gender'] == 'other' ? 'selected' : '' ?>>Otro</option>
        </select>
    ...
    <div class="mb-3">
        ...
        <select class="form-select" id="status" name="status" required>
            <option value="active" <?= $clientData['status'] == 'active' ? 'selected' : '' ?>>Activo</option>
            <option value="inactive" <?= $clientData['status'] == 'inactive' ? 'selected' : '' ?>>Inactivo</option>
        </select>
        <div class="invalid-feedback">
